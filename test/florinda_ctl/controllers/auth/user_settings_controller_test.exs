defmodule FlorindaCtl.Auth.UserSettingsControllerTest do
  ...
  describe "GET /auth/users/settings" do
  ...
  describe "PUT /auth/users/settings (change password form)" do
  ...
  describe "PUT /auth/users/settings (change email form)" do
    @tag :capture_log
  ...
  describe "GET /auth/users/settings/confirm_email/:token" do
    setup %{user: user} do
